 ...
 *
 *      \author  aw
 *        \date: 2014/02/06 114:15:00
 *
 *        \brief RTC Driver for Epson rx8581/rx8581
 *			     
 *
 *	       Note: This driver is based on the rx8581 Linux Kernel 
 *	       	     Driver.
 * 		     The driver will be upstream in the Linux Kernel
 * 		     in release 3.14
 *
 *
 *---------------------------------------------------------------------------
			...
			const struct i2c_device_id *id)
{
	...
	rx8581->rtc = rtc_device_register(rx8581_driver.driver.name,
...
static int rx8581_remove(struct i2c_client *client)
{
	...
	rtc_device_unregister(rx8581->rtc);
